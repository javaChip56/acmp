...
public sealed class PostgresAuthPlatformUnitOfWork : IAuthPlatformUnitOfWork
{
    private readonly AuthPlatformPostgresDbContext _dbContext;

    public PostgresAuthPlatformUnitOfWork(AuthPlatformPostgresDbContext dbContext)
    {
        _dbContext = dbContext;
        ServiceClients = new PostgresServiceClientRepository(dbContext);
...
internal sealed class PostgresServiceClientRepository : IServiceClientRepository
{
    private readonly AuthPlatformPostgresDbContext _dbContext;

    public PostgresServiceClientRepository(AuthPlatformPostgresDbContext dbContext) => _dbContext = dbContext;
...
internal sealed class PostgresCredentialRepository : ICredentialRepository
{
    private readonly AuthPlatformPostgresDbContext _dbContext;

    public PostgresCredentialRepository(AuthPlatformPostgresDbContext dbContext) => _dbContext = dbContext;
...
internal sealed class PostgresCredentialScopeRepository : ICredentialScopeRepository
{
    private readonly AuthPlatformPostgresDbContext _dbContext;

    public PostgresCredentialScopeRepository(AuthPlatformPostgresDbContext dbContext) => _dbContext = dbContext;
...
internal sealed class PostgresHmacCredentialDetailRepository : IHmacCredentialDetailRepository
{
    private readonly AuthPlatformPostgresDbContext _dbContext;

    public PostgresHmacCredentialDetailRepository(AuthPlatformPostgresDbContext dbContext) => _dbContext = dbContext;
...
internal sealed class PostgresAuditLogRepository : IAuditLogRepository
{
    ...
    public PostgresAuditLogRepository(AuthPlatformPostgresDbContext dbContext) => _dbContext = dbContext;
...
internal sealed class PostgresAdminUserRepository : IAdminUserRepository
{
    private readonly AuthPlatformPostgresDbContext _dbContext;

    public PostgresAdminUserRepository(AuthPlatformPostgresDbContext dbContext) => _dbContext = dbContext;
...
internal sealed class PostgresAdminUserRoleRepository : IAdminUserRoleRepository
{
    private readonly AuthPlatformPostgresDbContext _dbContext;

    public PostgresAdminUserRoleRepository(AuthPlatformPostgresDbContext dbContext) => _dbContext = dbContext;
...
internal static class PostgresPaginationQuery
{
