        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BindingName = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    BindingType = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                    Status = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: false),
                    Algorithm = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                    PublicKeyPem = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PublicKeyFingerprint = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                    CertificateThumbprint = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                    StoreLocation = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    StoreName = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    CertificatePath = table.Column<string>(type: "nvarchar(1024)", maxLength: 1024, nullable: true),
                    PrivateKeyPathHint = table.Column<string>(type: "nvarchar(1024)", maxLength: 1024, nullable: true),
                    KeyId = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    KeyVersion = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
