...
public sealed class AuthPlatformSqlServerDbContext : DbContext
{
    public AuthPlatformSqlServerDbContext(DbContextOptions<AuthPlatformSqlServerDbContext> options)
        : base(options)
    {
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<ServiceClient>(entity =>
        {
            ...
            entity.Property(item => item.MetadataJson).HasColumnType("nvarchar(max)");
        ...
        modelBuilder.Entity<HmacCredentialDetail>(entity =>
        {
            ...
            entity.Property(item => item.EncryptedSecret).HasColumnType("varbinary(max)").IsRequired();
            entity.Property(item => item.EncryptedDataKey).HasColumnType("varbinary(max)").IsRequired();
            entity.Property(item => item.Iv).HasColumnType("varbinary(max)");
            entity.Property(item => item.Tag).HasColumnType("varbinary(max)");
            entity.HasOne<Credential>()
                .WithOne()
        ...
        modelBuilder.Entity<AdminUser>(entity =>
        {
            ...
            entity.Property(item => item.Status).HasConversion<string>().HasMaxLength(32).IsRequired();
            entity.Property(item => item.PasswordHash).HasColumnType("varbinary(max)").IsRequired();
            entity.Property(item => item.PasswordSalt).HasColumnType("varbinary(max)").IsRequired();
