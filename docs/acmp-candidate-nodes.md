...
| Issue Encrypted Credential Package | AccessOperator or AccessAdministrator uses the admin portal and credential management API to issue a recipient-side encrypted credential package. |
| Issue Encrypted Client Credential Package | AccessOperator or AccessAdministrator uses the admin portal and credential management API to issue a client-side encrypted credential package. |
